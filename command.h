...
#define IOCTL_SET_PID_RECORD	_IO(RECORDANDREPLAY_IO, 2)
//_IOW(RECORDANDREPLAY_IOW, 200, int)
#define IOCTL_GET_PID_RECORD	_IOR(RECORDANDREPLAY_IOR, 210, int)
...
#define IOCTL_SET_PID_REPLAY	_IO(RECORDANDREPLAY_IO, 3)
//_IOW(RECORDANDREPLAY_IOW, 201, int)
#define IOCTL_GET_PID_REPLAY	_IOR(RECORDANDREPLAY_IOR, 211, int)
#endif
